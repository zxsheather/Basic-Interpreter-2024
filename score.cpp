...
int main(int argc, char **argv) {
    ...
    try {
         ...
         **************************************************************/
        system("g++ --std=c++20 -o testcode Basic/Basic.cpp Basic/evalstate.cpp Basic/exp.cpp Basic/parser.cpp Basic/program.cpp Basic/statement.cpp Basic/Utils/error.cpp Basic/Utils/tokenScanner.cpp Basic/Utils/strlib.cpp");
